 ...
 */
 class TreeMockupD3Chart extends React.Component {
   ...
   */
  update = () => {
    const dataset = [20, 60, 30, 90, 50, 70, 20, 80, 100, 200, 300, 60, 80]
    // Disposal
    let w = 500;
    let h = 180;
    let margin = 30;
    ...
    */
    let yScale = d3
      ...
      // .domain([
      //   0,
      //   d3.max(dataset, function(d: Number) {
      //     return d;
      //   })
      // ])
    ...
    //   .enter()
    //   .append("text")
      // .text(function(d: string | number | boolean | d3.ValueFn<SVGTextElement, unknown, string | number | boolean | null> | null) {
      //   return d;
      // })
      // .attr("x", function(d, i) {
      //   return i * (w / dataset.length) + (w / dataset.length - barPadding) / 2;
      // })
      // .attr("y", function(d: string | number | boolean | d3.ValueFn<SVGTextElement, unknown, string | number | boolean | null> | null) {
      //   return yScale(d) + 10;
      // })
    ...
    let path;
    let width = 640, height = 600, haloWidth = 3, halo = "#fff", strokeOpacity = 0.4, strokeWidth = 1.5, stroke = "#555", fill = "#999", padding = 1, r = 3, linkTarget = "_blank", parentId = Array.isArray(data) ? d => d.parentId : null, id = Array.isArray(data) ? d => d.id : null
